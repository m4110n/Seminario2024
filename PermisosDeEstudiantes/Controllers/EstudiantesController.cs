...
namespace PermisosDeEstudiantes.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellido,Direccion,Telefono,Gmail")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellido,Direccion,Telefono,Gmail")] Estudiante estudiante)
        {
